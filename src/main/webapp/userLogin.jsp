  ...
  <body>
    <div class="container">
      <form class="form-signin" action="${pageContext.request.contextPath }/login" method="post">
        ...
        <input type="email" name="user_id" id="inputEmail" class="form-control" placeholder="Email address" value="brown" required autofocus>
        <label for="inputPassword" class="sr-only">Password</label>
        <input type="password" id="inputPassword" name="user_pass" class="form-control" placeholder="Password" value="pass" required>
        <div class="checkbox">
          <label>
